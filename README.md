...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1015&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-bridgesampling-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-bridgesampling` can be installed with `conda`:
...
```
mamba install r-bridgesampling
```

It is possible to list all of the versions of `r-bridgesampling` available on your platform with `conda`:
...
```
mamba search r-bridgesampling --channel conda-forge
```
...
mamba repoquery search r-bridgesampling --channel conda-forge

# List packages depending on `r-bridgesampling`:
mamba repoquery whoneeds r-bridgesampling --channel conda-forge

# List dependencies of `r-bridgesampling`:
mamba repoquery depends r-bridgesampling --channel conda-forge
```
